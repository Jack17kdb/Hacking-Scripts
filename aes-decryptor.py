...
inv_s_box = [
    ...
    0x90, 0xD8, 0xAB, 0x00, 0x8C, 0xBC, 0x16, 0xBC, 0x0D, 0xE0, 0xE0, 0x56, 0x39, 0xD1
]

def xtime(byte):
    return (((byte << 1) & 0xFF) ^ (0x1B if (byte & 0x80) else 0))

def key_expansion(key):
    expanded_key = []
    for i in range(0, len(key), 4):
        expanded_key.append(list(key[i:i+4]))
    return expanded_key
...
add_round_key(state, expanded_key[-1])
